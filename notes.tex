...
\begin{document}
  ...
  \section{Euploidy}
    ...
    \subsection{Triploidy}
      Triploids, contain have three sets of chromosomes, can result from the union of gamete and diploid cells, and are almost always sterile.
      This sterility is often used by plant breeders, who may want to deliberately grow seedless fruit.
