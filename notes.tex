...
\begin{document}
  ...
  \section{Mutation}
    ...
    \subsection{Molecular Mechanisms of Mutation}
      Changes to DNA occur quite frequently, but are usually corrected by enzymatic systems for DNA repair. Mutagens are physical or chemical agents that raise the
      frequency of mutations above their spontaneous rate, such as radiation.
      ...
      Other example processes include:
      \begin{itemize}
    ...
    \subsection{Repairing Damaged DNA}
      ...
      \subsubsection{Nucleotide Excision Repair}
        Nucleotide excision repair is used when there is no DNA glycosylase to recognize the problem base. Nucleotide exclusion repair relies on enzyme complexes
        to detect and release damaged fragments, which are then filled in by DNA polymerase and sealed with DNA ligase.
