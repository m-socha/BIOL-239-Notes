...
\begin{document}
  ...
  \section{Mendelian Genetics}
    ...
    \subsection{Analysis Techniques}
      \subsubsection{Punnet Squares}
        A Punnet Square is a chart that lists the possible gametes that may combine in a cross (one gamete list forms 1 dimension), and lists all
  ...
  \section{Meiosis}
    ...
    \subsection{Meiosis II}
      ...
      and yield four haploid cells in total.
  ...
  \section{Euploidy}
    ...
    \subsection{Triploidy}
      Triploids can result from the union of a gamete and haploid cells, and are almost always sterile. This sterility is often used by plant breeders,
