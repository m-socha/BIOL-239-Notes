...
\begin{document}
  ...
  \section{Course Overview}
    This is an introductory genetics course. Topics covered include:
    \begin{itemize}
  ...
  \section{Mendelian Genetics}
    Genetics is the study of heredity. The founder of modern genetics is considered to be Gregor Mendel,
    a 19th century Augustinian monk.

    \subsection{Artificial Selection}
      Artificial selection is the process in which humans select plants or animals to breed based
      on desired traits. Long before humans developed a solid understanding of genetics, they noticed
      that some parental traits have a tendency to appear in their offspring. Examples of plants and animals
      domesticated through this selective breeding include dogs, goats, sheep, cattle, cabbage, and maize.

    \subsection{Key Definitions}
      Below are definitions for some of this course's most important terms.
      \begin{itemize}
        \item \textbf{Phenotype:} An observable characteristic in an individual, which can be an appearance or behaviour.
        \item \textbf{Genotype:} The genetic composition of an individual, which in turn can control phenotypes.
        \item \textbf{Gene:} A discreet unit of heredity.
        \item \textbf{Allele:} An alternative form of a single gene. Most multicellular organisms have two alleles for each gene.
        \item \textbf{Dominant Allele:} An allele that is manifested in a phenotype regardless of the other allele.
          The phenotype in which this allele is manifested is known as a dominant phenotype.
        \item \textbf{Recessive Allele:} An allele that does not have an effect on a phenotype when a dominant allele is present.
          The phenotype in which this allele is manifested is known as a recessive phenotype.
        \item \textbf{Parental Types:} Phenotypes that reflect a previously existing parental genotype.
        \item \textbf{Recombination Types:} Phenotypes that reflect a genotype not present in the parent generation.
        \item \textbf{Filal Generation:} Subsequent offspring in a sequence of breeding, starting with the parental (P) generation
          and proceeding to filal 1 (F1), filal 2 (F2), and so forth.
      \end{itemize}

    \subsection{Mendel's Experiments}
      Mendel is known as the father of modern genetics for running a series of experiments regarding trait inheritance. Much of the value of
      ...
      \begin{itemize}
        ...
        \item Establishment of pure-breeding lines, which are lines that only breed with other members of the same genotype.
        \item Carefully controlled breeding experiments that involved crossing these pure-breeding lines with one another, and later
          crossing individuals in the produced generations.
      \end{itemize}
    ...
    \subsection{Genetics Prior to Mendel}
      ...
      \begin{itemize}
        \item One parent contributing more to an offspring the other - disproved through reciprocal crosses (i.e. pairs of crosses between
          a male of one strain and a female of another, and then vice versa).
        \item Parental traits become blended (i.e. no discrete traits) - disproved through reappearance of parental traits in later generations.
      \end{itemize}
    ...
    \subsection{Mendel's Laws}
      ...
      \subsubsection{Law of Segregation}
        This law states that each trait is controlled by two alleles which separate upon gamete formation and recombine when a zygote is formed.

      \subsubsection{Law of Independent Assortment}
        This law states that alleles for separate phenotypic traits are transmitted to offspring independent of one another. This can be
        demonstrated through multihybrid experiments, where individuals differing in multiple traits are crossed with one another. In practice,
        this law does not always hold (see section on gene linkage for more information).

      \subsubsection{Law of Dominance}
        This law introduces the concept of dominant and recessive alleles, and states that recessive alleles do not affect phenotype unless
        both alleles are recessive.

    \subsection{Types of Crosses}

      \subsubsection{Monohybrid crosses}
        Monohybrid crosses feature mating between homozygous (i.e. both alleles the same) individuals that only differ in one trait.
        The F1 filal features only the dominant phenotype, while the F2 filal, which is produced by mating between individuals in the F1 filal,
        features the dominant phenotype and recessive phenotype in a 3:1 ratio.

      \subsubsection{Dihybrid crosses}
        Dihybrid crosses feature mating between homozygous individuals that only differ in two unrelated traits. The F1 filal features both
        dominant phenotypes, while the F2 filal features a 9:3:3:1 ratio of traits 1 and 2 both being dominant, trait 1 being dominant
        and trait 2 being recessive, trait 1 being recessive and trait 2 being dominant, and both traits being recessive.

      \subsubsection{Multihybrid crosses}
        Multihybrid crosses feature mating between individuals that only differ in three or more unrelated traits.
  ...
  \section{Genetic Code}
    ...
    \subsection{``Cracking'' the Genetic Code}
      ...
      \subsubsection{Triplet Codons}
        ...
        of the generated polypeptide. Crick and Brenner demonstrated that combining three such insertion or deletion mutations might not result in such
  ...
  \section{Transcription}
    ...
    \subsection{Addition of Cap and Tail}
      ...
      known as a methylated cap, and is essential for the efficient translation of RNA.
  ...
  \section{Prokaryotic Gene Expression}
    ...
    \subsection{E. Coli's Utilization of Sugar Lactose}
      ...
      \subsubsection{Trans vs Cis Action}
        Elements acting in trans can diffuse through cytoplasm and act on any DNA molecule in a cell. Cis elements only influence their own DNA molecule (e.g. operators).
  ...
  \section{Cancer Genetics}
    ...
    \subsection{Tumor-Suppressor Genes}
      ...
      \subsubsection{TP53}
        The TP53 gene produces the p53 protein, which in turn turns on transcription for a cyclin-dependent kinase (CDK) inhibitor known as p21.
      ...
      \subsubsection{RB}
        The retinoblastoma (RB) gene produces a protein called Rb that inhibits a transcription factor known as E2F. Some CDK complexes, which
