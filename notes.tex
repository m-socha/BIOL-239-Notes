...
\begin{document}
  ...
  \section{Eukaryotic Gene Expression}
    ...
    \subsection{Chromatin Structure}
      ...
      transcription. Chromatin structure changes are examples of epigenetic changes, which are changes in gene expression not related to sequence changes.
      ...
      \subsubsection{DNA Methylation}
        ...
        sequences, and methylated promoters are effectively turned off, preventing transcription. DNA methylation patterns may be inherited from a parent.
        In this case, the expression of an allele may depend on which parent it originates from, which is a phenomenon known as gene imprinting.
