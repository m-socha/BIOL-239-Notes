...
\begin{document}
  ...
  \section{Cancer Genetics}
    ...
    \subsection{Characteristics of Cancer Cells}
      A few common for cell division control include:
      \begin{itemize}
        ...
        \item Apostosis (i.e. programmed cell death), which is activated by the expression of genes in a cell starved of growth factor or a cell with heavily
          damaged DNA.
      \end{itemize}

      Cancer cells sometimes create their own growth stimuli (autocrine stimulation), or sometimes loose gap junctions or gap junctions. Cancer often also
      become ``immortal'' through the generation of large amounts of telomerase, which can prevent apostosis.
    ...
    \subsection{Tumor-Suppressor Genes}
      ...
      when both copies of a tumor-suppressor gene are mutated and fail to function (mutant alleles acts recessively).
      ...
      \subsubsection{TP53}
        ...
        expression of some genes encoding DNA repair enzymes. If a cell is too damaged for repair, the p53 proteins initiates apostosis.
      ...
      \subsubsection{RB}
        ...
        are controlled by p53, phosphorylate Rb to prevent it from inhibiting E2F. Thus, Rb is also necessary, along with p53, to control cell growth.
